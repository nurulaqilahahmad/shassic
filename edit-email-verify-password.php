...
<head>
    ...
    <title>SHASSIC | Verify Password</title>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-header py-3">
                                            ...
                                            <!-- Page Heading -->
                                            <h1 class="h3 mb-4 text-gray-800 font-weight-bold">Verify Password</h1>
                                        </div>
                                            ...
                                            <form class="user" method="POST">
                                                ...
                                                <div class="form-group" id="row">
                                                    ...
                                                    <div class="col-sm-4 mb-3 mb-sm-0">
                                                        <p class="font-weight-bold">Enter your password to continue</p> 
                                                ...
                                                <div class="form-group" id="row">
                                                    <div class="col-sm-4 mb-3 mb-sm-0"></div>
                                                    <div class="col-sm-4 mb-3 mb-sm-0">
                                                        <button type="submit" class="btn btn-primary btn-user btn-block font-weight-bold" name="verify-password">Verify</button>
                                                    </div>
                                                    <div class="col-sm-4 mb-3 mb-sm-0"></div>
                                                </div>
                                            </form>
