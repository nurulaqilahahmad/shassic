...
<head>
    ...
    <title>SHASSIC | Edit Profile</title>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-header py-3">
                                            ...
                                            <!-- Page Heading -->
                                            <h1 class="h3 mb-4 text-gray-800 font-weight-bold">Edit Profile</h1>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form class="user" method="POST">
                                                ...
                                                <div class="form-group" id="row">
                                                    <div class="col-sm-10 mb-3 mb-sm-0">
                                                        <input type="password" class="form-control form-control-user font-weight-bold" name="password" id="password" disabled="disable" placeholder="<?php echo htmlentities($result->password); ?>" required value="Change Password">
                                                    </div>
                                                    <div class="col-sm-2 mb-3 mb-sm-0">
                                                        <a class="btn btn-secondary btn-user btn-block font-weight-bold" href="edit-password.php">Edit Password</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group" id="row">
                                                    ...
                                                    <div class="col-sm-4 mb-3 mb-sm-0">
                                                        <button type="submit" class="btn btn-primary btn-user btn-block font-weight-bold" name="update_profile">Update</button>
                                                    </div>
                                                    <div class="col-sm-4 mb-3 mb-sm-0"></div>
                                                </div>
