                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-header py-3">
                                            ...
                                            <!-- Page Heading -->
                                            <h1 class="h3 mb-4 text-gray-800 font-weight-bold">Change Email</h1>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form class="user" method="POST">
                                                ...
                                                <div class="form-group">
                                                    <input type="hidden" class="form-control form-control-user font-weight-bold" name="old_email" id="old_email" value="<?php echo htmlentities($result->email); ?>">
                                                </div>
                                                ...
                                                <div class="form-group" id="row">
                                                    <div class="col-sm-4 mb-3 mb-sm-0"></div>
                                                    <div class="col-sm-4 mb-3 mb-sm-0">
                                                        <button type="submit" class="btn btn-primary btn-user btn-block font-weight-bold" name="update-email">Update</button>
                                                    </div>
                                                    <div class="col-sm-4 mb-3 mb-sm-0"></div>
                                                </div>
                                            </form>
